...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 2. Perform auto-login to fetch tokens
      ...
      const errorMessage = typeof detail === 'string' 
        ...
        : Array.isArray(detail) 
          ...
          : "Failed to initialize organization tenant workspace.";
      setError(errorMessage);
    } finally {
      setLoading(false)
    }
    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-12 bg-zentra-bg font-sans">
      <div className="w-full max-w-md bg-white border border-zentra-border shadow-card p-8 rounded-3xl animate-fade-in-up">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-zentra-text tracking-tight">Create your account</h2>
          <p className="text-sm text-zentra-muted mt-2">Deploy your secure security workspace</p>
        </div>
        ...
        <div className="mb-6 flex flex-col items-center justify-center w-full">
          {googleClientId ? (
            ...
            >
              ...
              Sign up with Google (Dev Bypass)
            </button>
          )}
          ...
          <div className="relative w-full my-6">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-3 text-zentra-muted font-bold tracking-wider">Or email signup</span>
            </div>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="block text-sm font-semibold text-zentra-text mb-1.5">Organization Name</label>
            <input
              type="text"
              required
              value={orgName}
          ...
          <div>
            <label className="block text-sm font-semibold text-zentra-text mb-1.5">Work Email Address</label>
            <input
              type="email"
              required
              value={email}
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-zentra-border focus:border-zentra-blue focus:ring-2 focus:ring-zentra-blue/20 outline-none transition-soft text-sm"
            />
            <span className="text-xs text-zentra-muted mt-2 block font-medium">Minimum 8 characters with alphanumerics</span>
          </div>
        ...
        <p className="text-center text-sm font-medium text-zentra-muted mt-8">
          ...
          <Link href="/login" className="text-zentra-blue hover:underline font-bold">
            Sign in
          </Link>
        </p>
      </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-3xl border border-zentra-border p-6 max-w-sm w-full mx-4 shadow-xl">
            <div className="flex flex-col items-center mb-6">
              ...
              <h3 className="text-lg font-bold text-zentra-text">Sign up with Google</h3>
